            ...
            <div className="flex-1 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="x-compose-textarea min-h-[60px] text-sm"
                  rows={2}
                  maxLength={200}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="x-compose-textarea min-h-[80px]"
                  rows={3}
                  maxLength={maxChars}
                />
              </div>
        ...
        >
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="x-select w-full text-base py-3"
                >
                  {tones.map((tone) => (
            ...
            <motion.button
              ...
              className="x-button w-full text-lg py-4 sm:py-3"
